...
def modelos_func_clasificacion(df, modelos, x_, y_):
    ...
    # Guarda el escalador en Google Drive
    ...
    for i in modelos:
        ...
        joblib.dump(modelo, f'{db_path}{nombre}_entrenado.pkl')
    ...
    # Guardar DataFrame de probabilidades en archivo CSV en Google Drive
    probabilidades_final_df.to_csv(f'{db_path}probabilidades_modelos.csv', index=False)

    return probabilidades_final_df
